...
const projectDetails = [
  {
    id: 0,
    title: 'CodePlanet Web Development Course',
    popTitle: 'Learn to Code in the Most <br> Simplified Way',
    popDescription: 'Code Planet is a web development site for learning courses like Html, CSS, JavaScript and anything that is related to web development. Code Planet got you, we are here to help you no matter who you are. Join the big family and have an amazing journey in tech world 🌍️. CodePlanet is a global community of people learning to code together. We believe coding is for everyone, and we\'re on a mission to make it accessible to everyone.',
    image: './img/project-img/codeplanet.jpg',
    popImage: './img/project-img/codeplanet.jpg',
    technologies: ['Codekit', 'Github', 'Ruby on rails', 'css', 'JavaScript', 'Bootstrap', 'Terminal', 'Codepen'],
    liveLink: 'https://io-oseinana.github.io/Capstone-code-planet/',
    sourceLink: 'https://github.com/io-oseinana/Capstone-code-planet',
    icon1: shareIcon,
    icon2: liveIcon,
  },
  {
